  ...
  return (
    <>
      <Container className="mt-5 ">
        {/* Download the page as pdf button */}
        <div className="d-flex justify-content-end">
          <button
            className="btn btn-primary mb-3 " 
            onClick={() => {
              window.print();
            }}style={{ background: "#2aa318"}}
          >
            Download Report
          </button>
        </div>
        <Row>
          <div className="col-lg-3 col-md-6 mb-4">
            <div className="card h-100">
              <div className="card-header text-black"style={{ background: "#24ff00" }}>
                <span style={{ fontWeight: "bold" }}>Total Transactions:</span>{" "}
                {TotalTransactions}
              </div>
              <div className="card-body"style={{ background: "#d6d3d3" }}>
          ...
          <div className="col-lg-3 col-md-6 mb-4">
            <div className="card h-100">
              ...
              <div className="card-body"style={{ background: "#d6d3d3" }}>
                <h5 className="card-title" style={{ color: "green" }}>
                  Income: RS. <ArrowDropUpIcon /> {totalTurnOverIncome}{" "}
                  
                </h5>
                <h5 className="card-title" style={{ color: "red" }}>
                  Expense: RS. <ArrowDropDownIcon />
